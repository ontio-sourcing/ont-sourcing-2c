...
public class MyJwtCreator {
    ...
    private MyJwtCreator(Map<String, Object> headerClaims, Map<String, Object> payloadClaims) throws Exception {
        ...
        try {
            ...
            throw new Exception("Some of the Claims couldn't be converted to a valid JSON format : " + var6.getMessage());
        }
    }
